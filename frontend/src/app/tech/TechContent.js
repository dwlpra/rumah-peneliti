...
const pipeline = [
  ...
  { step: 4, icon: "🤖", title: "Multi-Agent AI Pipeline", tech: "0G Compute", desc: "3 agents run in parallel: Summarizer generates article, Scorer assesses quality, Tagger classifies domain. Agent 4 (Reviewer) answers reader questions on-demand." },
