...
async function run() {
  ...
  // Note: zero hash may match old curationHash entries, so we just check response format
  ok(typeof verifyHash.data.verified === "boolean", "Verify returns boolean result");
