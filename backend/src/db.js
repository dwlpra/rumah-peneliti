...
function seedIfEmpty() {
  ...
  stmts.insertArticle.run(
    ...
    0,
    JSON.stringify({ overall: 8.5, originality: 8, methodology: 9, clarity: 8, impact: 9 }),
    JSON.stringify({ domain: "blockchain-storage", field: "distributed-systems", difficulty: "intermediate" }),
    null
  );
  ...
  stmts.insertArticle.run(
    ...
    0,
    JSON.stringify({ overall: 9.1, originality: 9, methodology: 9, clarity: 9, impact: 10 }),
    JSON.stringify({ domain: "smart-contracts", field: "machine-learning", difficulty: "advanced" }),
    null
  );
