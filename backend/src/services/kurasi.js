/**
 * AI Kurasi Service — Z.AI GLM API
...
IMPORTANT:
- Title must be catchy and engaging, not the original paper title
- Write in natural, accessible English
- Explain complex concepts with simple analogies
- The article should be understandable by undergraduate students
- Keep it engaging and easy to read, like a quality science magazine article`;
